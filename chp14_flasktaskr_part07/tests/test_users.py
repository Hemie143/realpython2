...
from chp14_flasktaskr_part07.project import app, db, bcrypt
from chp14_flasktaskr_part07.project._config import basedir
from chp14_flasktaskr_part07.project.models import Task, User
...
class UsersTests(unittest.TestCase):
    ...
    def test_user_login_field_errors(self):
        response = self.app.post('/', data=dict(name='', password='python101', ), follow_redirects=True)
